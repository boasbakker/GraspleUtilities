...
- **Works on embedded Grasple pages** in Learning Management Systems like Brightspace
...
- Can be extended to support other LMS platforms where Grasple is embedded
